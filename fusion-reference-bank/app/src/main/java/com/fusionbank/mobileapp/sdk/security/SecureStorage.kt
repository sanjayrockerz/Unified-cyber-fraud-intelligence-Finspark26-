...
class SecureStorage(context: Context) {
    ...
    companion object {
        ...
        const val KEY_SDK_ACCESS_TOKEN = "key_sdk_access_token"
        const val KEY_SDK_ACCESS_EXPIRES_AT = "key_sdk_access_expires_at"
        const val KEY_BANKING_ACCESS_TOKEN = "key_banking_access_token"
        const val KEY_BANKING_ACCESS_EXPIRES_AT = "key_banking_access_expires_at"
        const val KEY_REFRESH_TOKEN = "key_refresh_token"
        const val KEY_BANKING_REFRESH_TOKEN = "key_banking_refresh_token"
