...
os.environ.setdefault("FUSION_AUTH_CLIENTS_JSON", json.dumps({"e2e-dashboard": {"secret": "e2e-dashboard-secret", "roles": ["analyst", "operator", "developer"], "tenant_id": "TENANT_FUSB_001"}}))
