...
export default function ThreatIntelligenceDashboard() {
  ...
  return (
    <div className="mx-auto flex max-w-[1800px] flex-col gap-5 p-6 pb-8 bg-[#07101C] min-h-screen text-soc-text selection:bg-soc-primary/30">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        {[
          ...
          { label: 'Detection Accuracy', value: '99.7%', border: 'border-l-2 border-cyan-500' },
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,1.9fr)_minmax(0,1fr)]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="border border-soc-border bg-[#101827] rounded-lg p-4 shadow hover:border-soc-primary transition-all">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Incident Queue */}
          <section className="border border-soc-border bg-[#101827] rounded-lg shadow overflow-hidden hover:border-soc-primary transition-all">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="border border-soc-border bg-[#101827] rounded-lg p-4 shadow hover:border-soc-primary transition-all flex flex-col gap-3">
            ...
            <div className="bg-[#0b1019] border border-soc-border/60 rounded p-3 font-mono text-[11px] leading-relaxed text-soc-muted min-h-[90px] shadow-inner relative overflow-hidden">
          ...
          <div className="border border-soc-border bg-[#101827] rounded-lg p-4 shadow hover:border-soc-primary transition-all flex flex-col gap-4">
      ...
      >
        {selectedTransaction && (
          <div className="flex flex-col gap-6 font-mono text-xs text-white">
            ...
            <div className="border-t border-soc-border pt-4 flex flex-col gap-3 bg-[#0b1019] p-3.5 rounded border">
          ...
          <div className="flex flex-col gap-5 font-mono text-xs text-white">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-soc-muted leading-relaxed bg-[#0b1019] p-3 border border-soc-border rounded">
